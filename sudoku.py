...
root.geometry("324x550") #324 pixels * 550 pixels


label = Label(root, text = "Solve the sodoku!").grid(row = 0, column = 0, columnspan=10)
...
def updateValues(s):
    ...
    if sol != "no":
        ...
        solvedLabel.configure(text = "No solution exist for this sudoku")
